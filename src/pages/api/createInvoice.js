...
const createInvoice = async (req, res) => {
    ...
    if (data){
        ...
        let boardsData = mondayData.data.items_by_column_values.filter(el => el.group.title == 'Final Deposit' || el.group.title == 'Drawings Deposit' || el.group.title == 'Production Deposit' || el.group.title == 'Delivery Deposit' || el.group.title == 'Stone Measure Deposit');
